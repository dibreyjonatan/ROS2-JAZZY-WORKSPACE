...
: ${AMENT_CURRENT_PREFIX:="/home/jonatan/ros2_ws/install/articubot_one"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/articubot_one/environment/pythonpath.sh"
